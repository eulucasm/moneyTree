...
import { LogIn, Key, Mail, Sparkles } from 'lucide-react-native';
import { signInWithEmailAndPassword, signInWithPopup, GoogleAuthProvider } from 'firebase/auth';
import { auth } from '../services/firebase';
import Toast from '../components/Toast';
import { useFinancials } from '../context/FinancialContext';

// Inline Google Icon for Web and fallback for Mobile
const GoogleIcon = () => {
  if (Platform.OS === 'web') {
    return (
      <svg width="18" height="18" viewBox="0 0 24 24" style={{ marginRight: 10 }}>
        <path
          fill="#4285F4"
          d="M23.745 12.27c0-.7-.06-1.4-.19-2.07H12v3.92h6.69c-.29 1.5-.1.85-2.06 2.18v2.77h3.3c1.92-1.78 3.02-4.4 3.02-7.5l-.2-.3z"
        />
        <path
          fill="#34A853"
          d="M12 24c3.24 0 5.95-1.08 7.93-2.91l-3.3-2.77c-.92.62-2.1 1-3.63 1-3.11 0-5.74-2.11-6.68-4.96H1.03v2.85C3.01 20.12 7.16 24 12 24z"
        />
        <path
          fill="#FBBC05"
          d="M5.32 14.36A7.16 7.16 0 0 1 4.9 12c0-.82.14-1.63.4-2.36V6.78H1.03A11.94 11.94 0 0 0 0 12c0 1.92.45 3.74 1.25 5.36l4.07-3z"
        />
        <path
          fill="#EA4335"
          d="M12 4.75c1.77 0 3.35.61 4.6 1.8l3.42-3.42C17.95 1.19 15.24 0 12 0 7.16 0 3.01 3.88 1.03 8.21l4.29 3.16c.94-2.85 3.57-4.96 6.68-4.96z"
        />
      </svg>
    );
  }
          ...
          <View style={styles.form}>
            ...
            >
              <Text style={styles.switchModeText}>
                Não tem conta? Crie uma gratuitamente
              </Text>
            </TouchableOpacity>
          </View>
